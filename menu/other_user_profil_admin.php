...
if (isset($_GET['pseudo'])) {
    $pseudo = $_GET['pseudo'];
    $pfp = urldecode($_GET['pfp']);
    $indice = find_user_indice($pseudo);
    if ($indice !== false) {
...
<body>
    ...
    <div class="global">
            ...
            <?php
                    $data=get_data1($_SESSION['id_user']);
                    if($data[8]==1){
                ...
                <button class="btn-class-name" onclick="redirect_Admin()">
        ...
        <div class="container">
            <?php
            if (file_exists($pfp)) {
                echo "<img class='pfp' src='$pfp' alt='Photo de profil de $pseudo'>";
            } else {
        ...
        <?php
            echo "<a href='modif_info_form_admin.php?pseudo=$pseudo'>";
            echo "<button type='button' class=button_change id='btn_load'>Modifier les infos</button>";
            echo "</a>";
        ?>
        <br>
        <button type="button" class=button_change id="btn_edit">Historique des messages</button>
        <?php
            echo "<a href='confirm_ban.php?pseudo=$pseudo'>";
            echo "<button type='button' class=button_change id='btn_upload'>Bannir cet utilisateur</button>";
            echo "</a>";
        ?>
...
<script>
    var userPseudo = "<?php echo $pseudo2; ?>";
    var userPseudo2 = "<?php echo $pseudo; ?>";
</script> 
</body>
</html>
