...
<html>
    ...
    <div class="global">
            <div class="button-container">
                <button class="button2" onclick="redirect_home()">
            ...
            <div class="form-container">
                <form id="loginForm" method="post" action="paiement_effectue.php">
                    <h2>Paiement</h2>
                    <h1>PAIEMENT UNIQUEMENT PAR CARTE BANCAIRE</h1>
                    <div>
                    ...
                    <button type="submit">Devenir PREMIUM</button>
                </form>
            </div>
        </div>
    </body>
