...
<html>
    <head>
        <meta charset="utf-8">
        <title>Accueil CY Roland Garros</title>
        <link rel="stylesheet" href="/menu/abonnements.css">
        <style>
            .form {
  display: flex;
...
.input_field[type=number] {
  -moz-appearance: textfield;
    ...
    <div class="global">
            ...
            <div class="modal" style="top: 30%; position: absolute;">
                <form class="form" method="post" action="paiement_effectue.php">
                ...
                <div class="credit-card-info--form">
                    ...
                    <input id="password_field" class="input_field" type="number" name="carte" title="Inpit title" placeholder="0000 0000 0000 0000">
                    </div>
                    <div class="input_container">
