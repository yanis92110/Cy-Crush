<?php
    ...
    $pseudo2 = isset($_SESSION['pseudo']) ? $_SESSION['pseudo'] : 'Invité';
    if(isset($_GET["p"])){
        $pseudo=$_GET["p"];
    ...
    $data400=get_data1($_SESSION['id_user']);
        if($data400[8]==1){
            $sub = json_encode(1);
        }
        else if($data400[4]==0){
...
<body>
    ...
    <div class="global">
        ...
        <div class="container">
            ...
            ?>
            <br>
            <button id="commencerConv" onclick="isConv()">Envoyer un message</button>
            <br>
    ...
    <script>
        ...
        if(!sub){
            ...
            var doc3 = document.getElementById('commencerConv');
