...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="abonnements.css">
        ...
        <div class="global">
            ...
            <div class="container">
                <div class="vignette">
                    ...
                    10€/mois
                    <li>Accès en priorité au site</li>
                    <li>Accès à la messagerie premium</li>
                    <li>Possibilité de rechercher des pros/semi pros</li>
                    <button class="inscription" onclick="redirect_Sub()">Je m'inscris !</button>
                </div>
                <div class="vignette">
                    <h2>COMPTE PREMIUM</h2>
                    25€ tous les 3 mois
